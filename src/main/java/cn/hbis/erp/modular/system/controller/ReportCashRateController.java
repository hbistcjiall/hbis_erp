...
//        model.addAttribute("company", EnumCompany.toMap());
    ...
    /**
     * @Title ReportCashRateAction.cashRateDetailExport
     * @Description 导出客户兑现率明细
     * @author zhangry12988
     ...
     * @throws
     */
//    @RequestMapping(value="/cashRateDetailExport")
//    public void cashRateDetailExport(ReportCashRateQuery query,HttpServletRequest request,HttpServletResponse response) {
//        if (null == orderStopDateS || "".equals(orderStopDateS)) {
//            orderStopDateS = DateUtil.getLastMonth();
//            orderStopDateE = DateUtil.getLastMonth();
//        }
...
//        }
//        //开始导出
//        reportCashRateManager.cashRateDetailExport(query, request, response);
//    }
    /**
