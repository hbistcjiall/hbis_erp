...
public interface ScmSteelSettleMapper extends BaseMapper<ScmSteelSettle> {
    List<ScmSteelSettle> getcx(@Param("dw") String dw,@Param("cx") List cx,@Param("startTime") String startTime,@Param("endTime")String endTime,@Param("startagainTime") String startagainTime,@Param("endagainTime")String endagainTime);
    ...
    List<ScmSteelSettle> getcxhtjd(@Param("startTime") String startTime,@Param("endTime") String endTime,@Param("year") String year,@Param("cxName") List cxName,@Param("companyId") String companyId);
    List<ScmSteelSettle> getpzhtjd(@Param("startTime") String startTime,@Param("endTime") String endTime,@Param("year") String year,@Param("pzName") String pzName);
