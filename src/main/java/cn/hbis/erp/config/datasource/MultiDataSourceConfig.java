package cn.hbis.erp.config.datasource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "hbis.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = {"cn.hbis.erp.modular.*.mapper", "cn.hbis.erp.multi.mapper"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "hbis.muti-datasource")
    ...
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        DruidDataSource dataSourceHbis = dataSource(druidProperties);
        ...
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[0], dataSourceHbis);
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[1], bizDataSource);
        dynamicDataSource.setTargetDataSources(hashMap);
        dynamicDataSource.setDefaultTargetDataSource(dataSourceHbis);
