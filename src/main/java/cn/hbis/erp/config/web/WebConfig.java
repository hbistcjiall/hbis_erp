...
import cn.hbis.erp.core.common.controller.HbisErrorView;
import cn.hbis.erp.core.interceptor.AttributeSetInteceptor;
import cn.hbis.erp.core.interceptor.RestApiInteceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new RestApiInteceptor()).addPathPatterns("/hbisApi/**");
     ...
     */
    @Bean("error")
    public HbisErrorView error() {
        return new HbisErrorView();
    }
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        String patterns = "cn.hbis.erp.modular.*.service.*";
        //可以set多个
